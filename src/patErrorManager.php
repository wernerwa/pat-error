 ...
 *
 * $Id: patErrorManager.php 41 2005-09-19 14:43:27Z argh $
 *
 * @package patError
 */
...
class patErrorManager
{
     ...
     */
    public function &raise($level, $code, $msg, $info = null)
    {
        // ignore this error?
        ...
        $result     =   patErrorManager::$function($error, $handling);
        return $result;
    }
     ...
     */
    public function registerErrorLevel($level, $name)
    {
     ...
     */
    public function translateErrorLevel($level)
    {
        if (isset($GLOBALS['_pat_errorLevels'][$level])) {
     ...
     * @see raise()
     */
    public function &handleErrorIgnore(&$error, $options)
    {
        return $error;
    }
     ...
     * @see raise()
     */
    public function &handleErrorEcho(&$error, $options)
    {
     ...
     * @see raise()
     */
    public function &handleErrorVerbose(&$error, $options)
    {
        $level_human    =   patErrorManager::translateErrorLevel($error->getLevel());
        $info           =   $error->getInfo();
     ...
     * @see raise()
     */
    public function &handleErrorDie(&$error, $options)
    {
        $level_human    =   patErrorManager::translateErrorLevel($error->getLevel());
     ...
     * @see raise()
     */
    public function &handleErrorTrigger(&$error, $options)
    {
     ...
     * @see raise()
     */
    public function &handleErrorCallback(&$error, $options)
    {
        $opt    =   $options['options'];
     ...
     * @see raise()
     */
    public function &handleErrorException(&$error, $options)
    {
